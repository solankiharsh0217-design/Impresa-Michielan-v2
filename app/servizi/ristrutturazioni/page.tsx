...
export default function RistrutturazioniPage() {
  ...
  const features = [
    ...
    'Materiali certificati di qualità',
    'Supervisione totale dei lavori',
    'Presenza costante del titolare',
    'Rispetto tempi e costi',
    'Assistenza post-lavoro',
    'Garanzia sui lavori'
  ]

  const process = [
    { step: '01', title: 'Consulenza', description: 'Analisi esigenze e sopralluogo gratuito' },
    { step: '02', title: 'Progettazione', description: 'Sviluppo progetto dettagliato' },
    { step: '03', title: 'Preventivo', description: 'Proposta trasparente e dettagliata' },
    { step: '04', title: 'Esecuzione', description: 'Realizzazione con supervisione costante' },
    { step: '05', title: 'Controllo', description: 'Verifica qualità in ogni fase' },
    { step: '06', title: 'Consegna', description: 'Consegna chiavi in mano' }
  ]
    ...
    <>
      <section className="relative h-[500px] flex items-center justify-center text-white overflow-hidden mt-28">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6">Ristrutturazioni Complete</h1>
          <p className="text-2xl text-white/90 max-w-3xl mx-auto">Progetti chiavi in mano con supervisione totale</p>
        </div>
      </section>
